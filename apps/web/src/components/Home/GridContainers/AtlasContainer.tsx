...
export default function AtlasContainer(props: {
  ...
  const [thumbUrlsByAssetKey, setThumbUrlsByAssetKey] = useState<Record<string, string>>({});
                    ...
                    >
                      <div
                        ...
                        {assetTiles.map((asset, i) => {
                          const thumbUrl = asset.key
                            ? thumbUrlsByAssetKey[asset.key]
                            : "";
                          ...
                          return (
                            <div
                              key={`${asset.key || asset.assetId || asset.name}-${i}`}
                              style={{
                                width: "100%",
                                height: "100%",
                                boxSizing: "border-box",
                                ...
                                {thumbUrl ? (
                                  ...
                                  <div
                                    style={{
                                      ...
                                      borderRadius: 4,
                                      background:
                                        "linear-gradient(180deg, rgba(227,242,248,0.15) 0%, rgba(195,222,233,0.65) 100%)",
